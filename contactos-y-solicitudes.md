...
## 1. Matrícula consular (la más importante — puede resolver todo de una vez)

**A quién pedir:** Politisches Archiv des Auswärtigen Amts (archivo histórico de la cancillería alemana)
**Dirección:** Kurstraße 36, 10117 Berlin, Alemania
**Teléfono:** +49 (30) 1817-2179
**Formulario de contacto / info:** https://archiv.diplo.de/arc-de/das-politische-archiv/kontakt

**Qué pedir:** la ficha de matrícula consular "Santiago 1-687" a nombre de Vermehren
(Friedrich Wilhelm August / Federico Guillermo Augusto), del Consulado alemán en Santiago de Chile,
que debería incluir fecha/lugar de nacimiento, matrimonio y datos de los hijos inscritos.

**Borrador de correo (alemán):**
```
Betreff: Anfrage zu Matrikeleintrag Santiago 1-687 – Familie Vermehren

Sehr geehrte Damen und Herren,

ich bitte um Auskunft bzw. eine Kopie des Matrikeleintrags des Deutschen Konsulats
Santiago de Chile, Referenz "Santiago 1 - 687", lautend auf den Namen Vermehren
(Friedrich Wilhelm August Vermehren, geb. 1845 in Lübeck, ausgewandert nach Chile,
verheiratet mit Clara Teresa Schulze).

Ich bin Nachfahrin dieser Familie und benötige den Eintrag für ein
Staatsangehörigkeitsverfahren nach § 5 StAG beim Bundesverwaltungsamt.
...
Dirección: Mühlendamm 1-3, 23552 Lübeck, Alemania
Teléfono: +49 451 1224152
Email: archiv@luebeck.de

**Si el matrimonio fue después de 1870:** los libros pasan al Kirchenkreisarchiv Lübeck-Lauenburg,
consultable también vía el portal **Archion** (www.archion.de, requiere suscripción/registro) — vale
la pena buscar ahí primero "Vermehren" + "Lübeck" antes de escribir.

**Qué pedir:** copia certificada del acta de matrimonio de Friedrich Wilhelm August Vermehren
(n. 1845, Lübeck, hijo de Daniel August Bernhard Vermehren y Henriette Friederike Wilhelmine Lundt)
con Clara Teresa Schulze, estimado entre 1865 y 1873. Y, de paso, confirmar/copia certificada del
acta de bautismo N°605 que ya tenemos (para verificar que corresponde a la misma persona).

**Borrador de correo (alemán):**
```
Betreff: Anfrage nach Trauregister-Eintrag Vermehren/Schulze, Lübeck ca. 1865–1873

Sehr geehrte Damen und Herren,

im Rahmen einer familiengeschichtlichen Recherche suche ich den Eintrag zur Eheschließung
von Friedrich Wilhelm August Vermehren (geb. 15. September 1845 in Lübeck, Sohn von Daniel
August Bernhard Vermehren und Henriette Friederike Wilhelmine Lundt) mit Clara Teresa
Schulze, vermutlich zwischen 1865 und 1873 in Lübeck geschlossen.

Können Sie mir mitteilen, ob ein solcher Eintrag in Ihren Beständen vorhanden ist, und mir
gegebenenfalls eine beglaubigte Kopie zusenden?
...
## 3. Acta de matrimonio en Chile (si la boda fue después de emigrar)

Dado que el primer hijo (Carlos Oscar Augusto) nació en Chile en 1873, es posible que el matrimonio
haya sido en Chile, no en Alemania — en la comunidad alemana luterana.

**A quién pedir:**
**Iglesia Luterana de La Santa Cruz, Valparaíso** (la congregación alemana histórica más antigua de Chile)
Dirección: Abtao 689, Cerro Concepción, Valparaíso
Teléfono: (32) 297 5476
Web: www.iluterana.cl

**Qué pedir:** si tienen registro propio, o si pueden derivar a la congregación de Concepción
(fundada 1904 — puede ser tarde para este matrimonio si fue antes de esa fecha) o de Santiago.
También preguntar si tienen registro de nacimiento/bautismo de Carlos Oscar Augusto Vermehren
Schulze (1873) — resolvería otro pendiente del checklist.

**Borrador de correo (español):**
```
Asunto: Búsqueda genealógica — matrimonio Vermehren/Schulze, ca. 1865-1873

Estimados,

Estoy investigando la historia de mi familia y busco el registro de matrimonio de
Friedrich Wilhelm August Vermehren (también conocido como Federico Guillermo Augusto
Vermehren) con Clara Teresa Schulze, posiblemente en Valparaíso entre 1865 y 1873.
También agradecería saber si existe registro de bautismo de su hijo Carlos Oscar
Augusto Vermehren Schulze, nacido en 1873.

¿Podrían indicarme si tienen estos registros en sus archivos, o derivarme a la
congregación correspondiente?
...
## Orden recomendado
1. Buscar primero en **Archion.de** (gratis buscar índice, pago por ver imagen) — puede ahorrar las cartas.
2. Enviar en paralelo los 3 correos de arriba — no dependen uno del otro.
3. La matrícula consular (Berlín) es la que más probablemente resuelve todo de un solo golpe — priorizarla si hay que elegir solo una.
